...
# Fetch Bus bookings for the user
query = """SELECT t.BusID, t.DayOfWeek, t.Price, t.JourneyTime, j.Departure, j.Destination
           FROM BusBooking tb
           JOIN Account a ON tb.AccountID = a.AccountID
           JOIN Bus t ON tb.BusID = t.BusID
...
print("<html>")
print("<head><title>Bus Bookings</title> <link href=\"CSS.css\" rel=\"stylesheet\" type=\"text/css\"></head>")
print("<body>")
print("<div class=\"card\">")
print("<div class=\"card2\">")
print("<h1 class=\"BookYourTrain\">Your Bus Bookings:</h1>")
print("<table border='1'>")
print("<tr><th class=\"BookYourTrain\">Bus ID</th><th class=\"BookYourTrain\">Day of Week</th><th class=\"BookYourTrain\">Price (£)</th><th class=\"BookYourTrain\">Journey Time (hrs)</th><th class=\"BookYourTrain\">Departure</th><th class=\"BookYourTrain\">Destination</th></tr>")
